...
- Wait! You said better, cheaper, and faster? By alleviating IO, the framework accelerates data generation thus training. By reducing disk storage use it also makes it cheaper. By enabling greater data diversity it improves training quality. Check the [paper](../../../assets/pdf/High_Throughput_Training_of_Deep_Surrogates_from_Large_Ensemble_Runs.pdf) for more details.
